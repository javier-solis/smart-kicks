...
//   char mac_string[30];
//   sprintf(mac_string, "\"macAddress\": \"%02x:%02x:%02x:%02x:%02x:%02x\",", mac_address[0], mac_address[1], mac_address[2], mac_address[3], mac_address[4], mac_address[5]);
//   strcat(test_str, mac_string);

//   char signal_str[30];
//   sprintf(signal_str, "\"signalStrength\": %d,", signal_strength);
//   strcat(test_str, signal_str);

//   strcat(test_str, "\"age\": 0,");

//   char channel_str[30];
//   sprintf(channel_str, "\"channel\": %d", channel);
//   strcat(test_str, channel_str);

//   strcat(test_str, "}");

//   if (strlen(test_str) > os_len) {
//     return 0;
//   }
//   else {
//     sprintf(object_string, test_str);
//     return strlen(object_string);
//   }
